...
namespace CP.FastConsig.Util
{
    ...
    public static class StringHelper
    {
                                                ...
                                                params string[] hasWords)
        {
            ...
            {
                sb.AppendFormat("({0})|",
                                StringHelper.HtmlSpecialEntitiesEncode(s.Trim()));
            }
        ...
        public static string MaskString(string input, string mask)
        {
            ...
            try
            {
                ...
                List<char> maskedStringChars = new List<char>();
                ...
                foreach (char character in mask)
                {
                    ...
                    if (character.Equals('#'))
                    {
                        maskedStringChars.Insert(i, input.Length + decremento > i ? input[i - decremento] : '#');
                    }
                    else
                    {
                        maskedStringChars.Insert(i, character);
                        decremento++;
                    }
                ...
                return string.Join("", maskedStringChars.ToArray());
