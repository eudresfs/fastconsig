<%@ Control ClassName="WebUserControlConsignatarias" Language="C#" AutoEventWireup="True"
	CodeBehind="WebUserControlConsignatarias.ascx.cs" Inherits="CP.FastConsig.WebApplication.WebUserControls.WebUserControlConsignatarias" %>
...
<div class="GlobalUserControl">
	...
	<div>
		<asp:ObjectDataSource ID="ODS_Consignatarias" runat="server" TypeName="CP.FastConsig.BLL.ODS_Empresa"
			DataObjectTypeName="CP.FastConsig.DAL.Empresa" SelectMethod="SelectGrid" SortParameterName="sortExpression"
			SelectCountMethod="SelectGridCount" EnablePaging="True">
			<SelectParameters>
		...
		<asp:GridView OnSorting="grid_Sorting" CssClass="EstilosGridView" OnPageIndexChanging="grid_PageIndexChanging"
			...
			Width="100%" AutoGenerateColumns="False" OnRowDataBound="grid_RowDataBound"
			DataSourceID="ODS_Consignatarias" >
			...
			<Columns>
			 <asp:TemplateField>
					<ItemTemplate>
						<asp:LinkButton runat="server" ID="EditarEmpresa" OnClick="ImageButtonEditar_Click" CommandArgument='<%# Eval("IDEmpresa") %>' >
				...
				<asp:TemplateField HeaderText="Situação">
					<ItemTemplate>                        
                        <asp:Label runat="server" Text='<%# Eval("EmpresaSituacao.Nome") %>'></asp:Label>
					</ItemTemplate>
				</asp:TemplateField>
