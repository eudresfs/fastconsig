...
namespace CP.FastConsig.WebApplication.WebUserControls
{
    ...
    public partial class WebUserControlChartAreaVolumeInadimplencia : CustomUserControl
    {
        ...
        public void ConfiguraGrafico(string nomeArquivoScriptChartLinha, string titulo, string subTitulo, string tituloEixoY, string[] categorias, Dictionary<string, decimal[]> dados)
        {
            ...
            LimpaScripts();
            AdicionaArquivoScriptParaExecucao(nomeArquivoScriptChartLinha, tagsValores);
