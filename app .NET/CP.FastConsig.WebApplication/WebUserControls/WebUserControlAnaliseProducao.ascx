<%@ Control ClassName="WebUserControlAnaliseProducao" EnableViewState="true" Language="C#"
    AutoEventWireup="true" CodeBehind="WebUserControlAnaliseProducao.ascx.cs" Inherits="CP.FastConsig.WebApplication.WebUserControls.WebUserControlAnaliseProducao" %>
        ...
        <div style="margin-top: 5px;">
            <asp:Panel DefaultButton="btnBuscar" ID="PanelConciliacao" runat="server">
                <table width="100%" border="0" cellpadding="4" cellspacing="4">
                    <tr>
                        <td colspan="4" class="BordaBase" style="border: none; padding: 5px 0px;">
    ...
    <div id="DivResultado" runat="server" visible="false" style="padding: 5px 0px;">
        <table border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td style="padding: 5px 5px 5px 0px; width: 12%;">
                    <span style="font-weight:bold;">Exportar para: </span>
                </td>
        ...
        <dx:ASPxPivotGrid ID="ASPxPivotGridAnalise" ClientInstanceName="ASPxPivotGridAnalise"
            ...
            <Fields>
                ...
                <dx:PivotGridField Area="RowArea" AreaIndex="1" Caption="Tipo Produto" FieldName="TipoProduto"
                    ID="PivotGridField5" UnboundFieldName="" Options-ShowTotals="False" />
                <dx:PivotGridField Area="ColumnArea" AreaIndex="2" Caption="Tipo" FieldName="Tipo"
                    ID="PivotGridField1" UnboundFieldName="" SortOrder="Descending" />
                ...
                <dx:PivotGridField Area="DataArea" AreaIndex="0" Caption="Qtde." FieldName="Quantidade"
                    SummaryType="Sum" ID="PivotGridField4" UnboundFieldName="" />
                <dx:PivotGridField Area="DataArea" AreaIndex="2" Caption="Valor Consignado" FieldName="ValorConsignado"
                    SummaryType="Sum" ID="ColunaValor" UnboundFieldName="" />
                <dx:PivotGridField Area="DataArea" AreaIndex="1" Caption="Valor Mensal" FieldName="ValorMensal"
                    SummaryType="Sum" ID="PivotGridField2" UnboundFieldName="" />
                <dx:PivotGridField Area="DataArea" AreaIndex="3 " Caption="%" FieldName="Percentual"
                    SummaryType="Sum" ID="PivotGridField3" UnboundFieldName="" CellFormat-FormatType="Numeric" CellFormat-FormatString="{0:N}" />
            </Fields>
            <OptionsView ShowHorizontalScrollBar="True" ShowColumnGrandTotals="False" ShowRowGrandTotals="True" ShowColumnTotals="False" ShowFilterHeaders="false" />
            <OptionsPager RowsPerPage="60" />
