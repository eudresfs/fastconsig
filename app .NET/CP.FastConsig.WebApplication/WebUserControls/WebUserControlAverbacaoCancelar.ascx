<%@ Control ClassName="WebUserControlAverbacaoCancelar" Language="C#" AutoEventWireup="True"
    CodeBehind="WebUserControlAverbacaoCancelar.ascx.cs" Inherits="CP.FastConsig.WebApplication.WebUserControls.WebUserControlAverbacaoCancelar" %>
...
<div style="margin:5px 0px;">
    <table border="0" cellpadding="0" cellspacing="0" class="WebUserControlTabela">
        <tr>
            ...
            <td  style="border: none;">
                <asp:TextBox TextMode="MultiLine" CssClass="TextBoxDropDownEstilos" Height="150" Width="330" runat="server"
                    ID="txtMotivo" Rows="5" ></asp:TextBox>
            </td>
        </tr>
        <tr>
                    ...
                    <tr>
                        <td>
                            <dx:ASPxButton Cursor="Pointer" ID="ASPxButtonSalvar" EnableDefaultAppearance="false"
                                CssClass="BotaoEstiloGlobal" EnableTheming="false" runat="server" Text="Cancelar"
                                OnClick="SalvarClick" />
                        </td>
                    </tr>
                </table>
