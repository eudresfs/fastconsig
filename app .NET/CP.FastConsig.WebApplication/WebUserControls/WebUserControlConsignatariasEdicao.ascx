<%@ Control ClassName="WebUserControlConsignatariasEdicao" Language="C#" AutoEventWireup="True"
    ViewStateMode="Enabled" EnableViewState="true" CodeBehind="WebUserControlConsignatariasEdicao.ascx.cs"
    Inherits="CP.FastConsig.WebApplication.WebUserControls.WebUserControlConsignatariasEdicao" %>
...
<%@ Register Src="WebUserControlEmpresaSuspensoes.ascx" TagName="WebUserControlEmpresaSuspensoes"
    TagPrefix="uc4" %>
<%@ Register Src="WebUserControlProdutos.ascx" TagName="WebUserControlProdutos" TagPrefix="uc2" %>
    ...
    <div>
        <%--<div style="margin: 3px;">
            <asp:Button ID="ButtonNovo" OnClick="ButtonNovo_Click" class="BotaoEstiloGlobal"
                Width="80" runat="server" Text="Nova" />
        </div>--%>
                ...
                <td style="padding: 0;">
                    <table class="WebUserControlTabela" width="100%" border="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <dx:ASPxTextBox CssClass="TextBoxDropDownEstilos" Paddings-Padding="0" Width="331"
        ...
        <div style="text-align: left; width: 100%; padding-bottom: 5px; padding-top: 5px;">
            ...
            <asp:Button CssClass="BotaoEstiloGlobal" ID="ButtonRestaurar" OnClick="ButtonRestaurarClick"
                Text="Restaurar Permissões (padrão)" runat="server" />
        ...
        <dx:ASPxPageControl ID="tabcontrol" Visible="False" Width="100%" runat="server" EnableCallBacks="true"
            ...
            TabSpacing="3px">
            <TabPages>
                <dx:TabPage runat="server" Text="Verbas/Produtos" Name="aba_Produtos">
                    <ContentCollection>
                        <dx:ContentControl ID="ContentControl1" runat="Server">
                            <uc2:WebUserControlProdutos ID="WebUserControlProdutos1" ExibirTitulo="false" IdRecursoWebUserControl="52"
                                EnableViewState="true" runat="server" />
                        </dx:ContentControl>
                    </ContentCollection>
                </dx:TabPage>
                <dx:TabPage runat="server" Text="Contatos" Name="aba_contatos">
                    <ContentCollection>
                ...
                <dx:TabPage runat="server" Text="Usuários" Name="aba_usuarios">
                    <ContentCollection>
                ...
                <dx:TabPage runat="server" Text="Parâmetros" Name="aba_parametros">
                    <ContentCollection>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList CssClass="TextBoxDropDownEstilos" runat="server" DataTextField="Nome"
                                            DataValueField="IDEmpresaTarifada" ID="DropDownListTipoTarifa" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="TituloNegrito">
                                    ...
                                    <td>
                                        <asp:TextBox CssClass="TextBoxDropDownEstilos" runat="server" ID="dfValorTarifa"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="TituloNegrito">
                                    ...
                                    <td>
                                        <asp:TextBox CssClass="TextBoxDropDownEstilos" runat="server" ID="dfDiaCorte"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="TituloNegrito">
                                    ...
                                    <td>
                                        <asp:TextBox CssClass="TextBoxDropDownEstilos" runat="server" ID="dfDiaRepasse"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </dx:ContentControl>
                ...
                <dx:TabPage runat="server" Text="Bloquear/Suspender/Ativar" Name="aba_suspensoes">
                    <ContentCollection>
